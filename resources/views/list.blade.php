...
<head>
    ...
    <title>shop bán hàng laravel pree</title>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>shop</span>bán hàng</h1>
									<h2>pree mọi người cứ lấy</h2>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>shop</span>bán hàng laravel</h1>
									<h2>lấy j cứ lấy pree</h2>
									<p> sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
						...
						<!-- chỗ nàu là thương hiệu cùng laoij sp -->
	<section>
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
			...
			<!-- end thương hiệu cùng loại sp trên thanh me trái -->
